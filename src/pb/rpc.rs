...
impl<'a> ::std::default::Default for &'a LeaseLeasesRequest {
    fn default() -> &'a LeaseLeasesRequest {
        <LeaseLeasesRequest as ::protobuf::Message>::default_instance()
    }
}
...
impl<'a> ::std::default::Default for &'a LeaseStatus {
    fn default() -> &'a LeaseStatus {
        <LeaseStatus as ::protobuf::Message>::default_instance()
    }
}
...
impl<'a> ::std::default::Default for &'a LeaseLeasesResponse {
    fn default() -> &'a LeaseLeasesResponse {
        <LeaseLeasesResponse as ::protobuf::Message>::default_instance()
    }
}
